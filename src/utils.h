...
//compute Kronecker product for two vector
VectorXd VV(const VectorXd& xx, const VectorXd& yy);

//standardize the vector or matrix columnwise
VectorXd Standardize(const VectorXd& x);
MatrixXd Stdm(const MatrixXd& x);
